...
Usage:
  ...
  ./setup-my-claude-linux.sh --complete --skill-scope project  Install project-capable skills in the current project folder
...
refresh_claude_path() {
  ...
  for dir in "/usr/local/bin" "/usr/local/sbin" "${HOME}/.npm-global/bin"; do
